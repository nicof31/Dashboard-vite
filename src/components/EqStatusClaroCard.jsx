...
const StatusCard = ({ team })  => {
  ...
  return (
    <div className="col-md-4 col-sm-6 mb-3">
      <div id='status-card' className={`card order-card bg-c-pink card-auto`}>
        <div className="card-block">
          <h4 id='text-card-status'className="m-b-20 card-status">
          EQUIPOS REPORTANDO SIM CLARO
          </h4>
...
const EqStatusClaroCard = ({ data, loading }) => {
...
export default EqStatusClaroCard;
